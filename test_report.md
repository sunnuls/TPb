...
- **Total Anomalies**: 54
- **Anomaly Rate**: 5.40%
- **Average Latency**: 67.5ms
- **Throughput**: 1.67 decisions/sec
- **Current Efficiency Score**: 40.3%
...
### Equity Distribution
- **High** (<0.3, 0.3-0.7, >0.7): 212 (21.2%)
- **Medium** (<0.3, 0.3-0.7, >0.7): 788 (78.8%)

## Optimization Opportunities

### 1. Anomaly rate is 5.4% (target: <3%)
